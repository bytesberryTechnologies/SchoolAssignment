...
function sendEmail(emailID) {
  const email = emailID;
  let message =
    "<b>Hi,</b><br/><br/><p style='text-align:center'><b>Greetings from Bytesberry Technologies!!!</b></p><br/>Thank you for your response. We as a Tech firm and are committed to work in the education space in providing digital solutions to help out Teachers and School Administrators for improving the quality of education being imparted.<br/>As our first endeavour, we have chosen Student’s Assignments as the priority to come up with a solution to meet this challenge head-on.<br/><br/>We will keep you posted on the progress. Please feel free to contact the numbers mentioned below for any queries.<br/><br/><br/><br/>Thank you.<br/>Bytesberry Technologies<br/>Basnett Building<br/>D.P.H. road, Behind Janta Bhawan<br/>Gangtok, East<br/>Sikkim – 737101<br/>Contact #: 85973-55169 / 98327-81875<br/>Email address: kripa@bytesberry.com / mrinaldeep@bytesberry.com<br/><br/><br/>";
  message +=
    "<small>This is an auto generated email and any files transmitted with it are confidential and intended solely for the use of the individual or entity to whom they are addressed. If you have received this email in error please notify the system manager. This message contains confidential information and is intended only for the individual named. If you are not the named addressee, kindly don not disseminate, distribute or copy this e-mail. Please notify the sender immediately by e-mail if you have received this e-mail by mistake and delete this e-mail from your system.</small>";
