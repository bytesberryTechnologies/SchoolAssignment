...
function sendEmail(emailID) {
  const email = emailID;
  let message =
    "<b style='font-size:16px;'>Hi,</b><br/><p style='text-align:center; font-size:16px;'><b>Greetings from Bytesberry Technologies!!!</b></p><p style='font-size:16px; text-align:justify;'>Thank you for your response. We as a technology firm are committed to work in the education space in providing digital solutions enabling teachers and school administrators to profoundly improve the quality of education being imparted.";
  message +=
    "<br/><br/>As our first endeavour, we have prioritized to work on challenges with regards to managing Student’s School Assignments for both teachers as well as parents.<br/><br/>As we embark in this journey, we would love to have you by our side all along helping us with your valuable suggestions and feedback.<br/><br/>We will keep you posted on the progress. Please feel free to contact the numbers mentioned below for any queries.<br/><br/><br/><br/>Thank you.<br/><br/><br/>Bytesberry Technologies<br/>Basnett Building<br/>D.P.H. road, Behind Janta Bhawan<br/>Gangtok, East<br/>Sikkim – 737101<br/>Contact #: 85973-55169 / 98327-81875<br/>Email address: kripa@bytesberry.com / mrinaldeep@bytesberry.com<br/><br/><br/></p>";
  message +=
